...
$params = array("author" => "Jessie Mique", "title" => "Personnel Information", "header" => false, "footer" => false, "output" => "certificate1.pdf");
$fontFamily = "times";
...
$pdf->writeHTML("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <b>".$title.$model->emp_firstname.' '.$model->emp_lastname."</b> is employed by Lorma Colleges as a Full-time Instructor of the ". $model->departments->name." from ". $model->joined_date." to ".$termination_date.".",true,false,false,false,'J');
$pdf->Cell(0, .5, "", 0, 1, 'L');
