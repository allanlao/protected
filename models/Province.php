 ...
 *
 * The followings are the available columns in table 'hs_hr_province':
 * @property integer $id
...
class Province extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('province_name', 'length', 'max'=>40),
	...
	public function search()
	{
        ...
        return $list = CHtml::listData($this->model()->findAll(array('order'=>'province_name')),
                'id', 'province_name');
