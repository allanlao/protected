...
{ 
  ...
  var dateLimit = new Date(sy,04,31,12,00,00) ;
if (strText != "")
{
    ...
    <fieldset>
       <br>
        ...
        <div class="control-group">
            <?php echo $form->labelEx($model, 'leave_date_filed', array('class' => 'control-label')); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                echo $form->dropDownList($model, 'emp_number', Employee::model()->getEmployees());
                ?>
...
<?php echo CHtml::listBox('datesList', 'selected', array(), array('multiple' => 'true','size'=>10)); ?>
        ...
        <div class="control-group">
            <div class="control-label">
<?php echo CHtml::label('Click to remove', 'btnRemove'); ?>
            </div>
            <div class="controls">
...
<?php echo $form->labelEx($model, 'leave_reason', array('class' => 'control-label')); ?>
            <div class="controls">
            <?php echo $form->textArea($model, 'leave_reason', array('class' => 'span6', 'rows' => '5')) ?>
            </div>
        </div>
       ...
       <?php echo $form->labelEx($model, 'remarks', array('class' => 'control-label')); ?>
            <div class="controls">
            <?php echo $form->textArea($model, 'remarks', array('class' => 'span6', 'rows' => '5')) ?>
            </div>
        </div>
