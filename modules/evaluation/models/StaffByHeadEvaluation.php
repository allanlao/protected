...
/**
 * This is the model class for table "staffByHeadEvaluation".
 *
 * The followings are the available columns in table 'staffByHeadEvaluation':
 ...
 */
class StaffByHeadEvaluation extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'staffByHeadEvaluationDetails' => array(self::HAS_MANY, 'StaffByHeadEvaluationDetails', 'emap_id'),
		);
	}
	 ...
	 * @return StaffByHeadEvaluation the static model class
	 */
