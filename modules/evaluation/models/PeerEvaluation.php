...
/**
 * This is the model class for table "peerEvaluation".
 *
 * The followings are the available columns in table 'peerEvaluation':
 ...
 */
class PeerEvaluation extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'peerEvaluationDetails' => array(self::HAS_MANY, 'PeerEvaluationDetails', 'emap_id'),
		);
	}
	 ...
	 * @return PeerEvaluation the static model class
	 */
