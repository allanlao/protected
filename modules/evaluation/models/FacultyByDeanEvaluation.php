...
/**
 * This is the model class for table "facultyByDeanEvaluation".
 *
 * The followings are the available columns in table 'facultyByDeanEvaluation':
 ...
 */
class FacultyByDeanEvaluation extends CActiveRecord
{
	/**
	...
	{
		return 'facultyByDeanEvaluation';
	}
	 ...
	 * @return FacultyByDeanEvaluation the static model class
	 */
