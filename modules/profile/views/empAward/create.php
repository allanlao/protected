...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
        ...
        'columns'=>array(
                ...
                array('header'=>'Description','name'=>'award_description','htmlOptions'=>array('width'=>'140')),
                'awarding_body',
                'award_date',
                'award_comments',
                ...
                array(
                        'class'=>'CButtonColumn',
                        'template'=>'{delete}',
                        'deleteButtonUrl'=>'Yii::app()->createUrl("profile/empAward/delete", array("id" => $data->award_id))',
